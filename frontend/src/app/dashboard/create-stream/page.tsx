                    ...
                    <div className="w-3/4 bg-muted rounded-xl p-2 flex">
                        ...
                        <div className="w-1/3 h-full">
                            ...
                            <ul className="space-y-2 mt-2 pr-2">
                                ...
                                <li className="w-full rounded-xl border bg-card p-2 flex items-center justify-between">
                                    <Label htmlFor="save_stream" className="text-md">Save Stream</Label>
                                    <Switch id="save_stream" className="h-5" onCheckedChange={
                                        () => {
                                            if (currentStream) {
                                                setStreamSettings({
                                                    ...streamSettings,
                                                    save_stream: !streamSettings?.save_stream,
                                                } as StreamSettings);
                                            }
                                        }
                                    } checked={streamSettings?.save_stream} />
                                </li>
                            </ul>
                        </div>
