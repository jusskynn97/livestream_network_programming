...
export default function NavigationBar({ isUserAuthenticated }: NavigationBarProps) {
    ...
    const { notifications } = useNotifications(isUserAuthenticated);
                            ...
                            <NotificationsListModal 
                                ...
                                <button className="flex items-center relative">
                                    ...
                                    {notifications.length > 0 && (
                                        <span className="absolute top-0 right-0 w-2 h-2 rounded-full bg-red-500 ring ring-background"></span>
                                    )}
                                </button>
                            } />
                        )}
